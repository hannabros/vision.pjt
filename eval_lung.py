...
if __name__ == "__main__":
    ...
    test_dataset = LungDataset(data_dir=args.data_dir, df=test_df, transform=get_transforms(data='test', args=args))  # file directory
    ...
    test_df.to_csv(os.path.join(args.output, args.experiment, f'result_{args.model}.csv'), index=False)
    tile_df.to_csv(os.path.join(args.output, args.experiment, f'tile_{args.model}.csv'), index=False)